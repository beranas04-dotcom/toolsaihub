                        ...
                        <div>
                            ...
                            <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-2">
                                <input
                                    ...
                                    className="flex-1 px-4 py-2 text-sm border border-input rounded-md bg-background focus:outline-none focus:ring-2 focus:ring-primary disabled:opacity-50"
                                />
                                <button
                                    type="submit"
                                    disabled={status === 'loading'}
                ...
                <div className="mt-12 pt-8 border-t border-border">
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        <p className="text-sm text-muted-foreground">
                            © {new Date().getFullYear()} {siteMetadata.siteName}. All rights reserved.
                        ...
                        <div className="flex space-x-6">
                            <a
                                href={`https://twitter.com/${siteMetadata.social.twitter.replace('@', '')}`}
                                target="_blank"
